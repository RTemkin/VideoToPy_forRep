...
class ObjectDetection:
    def __init__(self):
        ...
        self.model = YOLO('D:/VideoT0Py_forRep/runs/detect/train/weights/best.pt').to(self.device)
        ...
        # Регистрация обработчика команды /check
        ...
        self.output_dir = "D:/VideoT0Py_forRep/recorded_videos1/"
        self.save_images_dir = "D:/VideoT0Py_forRep/saved_images1/"
    ...
    async def start_polling(self):
        ...
        await self.dp.start_polling(skip_updates=True)

    async def send_photo_to_telegram(self, image_path):
        """Отправка изображения в Telegram"""
        try:
            photo = FSInputFile(image_path)
            await self.bot.send_photo(chat_id=CHAT_ID, photo=photo, caption='Обнаружен объект! Место нахождения')
